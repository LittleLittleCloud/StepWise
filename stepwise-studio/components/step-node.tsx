    ...
    >
      ...
      {step.name && (
        <div className="flex flex-col">
          ...
          {step.description && (
            <h6 className="text-xs text-primary/50 pl-5">{step.description}</h6>
          )}
        </div>
      )}
          ...
          <div className="flex flex-col gap-1">
            {parameters.map((param, index) => (
              <div
                key={index}
                ref={(el) =>
                  el && parameterRefMap.current.set(param.variable_name!, el)
                }
              >
                <ParameterCard
                  {...param}
                ...
                <Handle
                  ...
                  style={{
                    top: targetHandleTopOffsets.get(param.variable_name!),
                    left: 10,
                  }}
                />
              </div>
